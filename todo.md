...
- [x] Preparar checkpoint final e orientar publicação com domínio próprio

## Histórico de solicitações

- [x] Estruturar plano de comunicação com site, série de posts para Instagram/LinkedIn e processo operacional de atendimento ao cliente
- [x] Documentar como substituir o CTA de agendamento por WhatsApp/e-mail real do consultor antes da publicação
...
- [x] Manter CTA funcional de retorno ao formulário e documentar a substituição por canal real de agendamento
...
- [x] Documentar como exportar o projeto para o computador do usuário
